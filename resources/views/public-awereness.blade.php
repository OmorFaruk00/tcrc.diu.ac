...
@section('title', 'public_awereness')

@section('content')
<section class="page-bg">
    <div class="container">
          <div class="" data-aos="fade-up" data-aos-delay="200">
            <h1 class="page-title">Our Public  Awereness</h1>
            ...
            <button class="page-btn"> <a href="{{route('home')}}">Home</a>  <i class="fas fa-arrow-right"></i> Public  Awereness</button>         
          </div>        
      </div>
</section>
