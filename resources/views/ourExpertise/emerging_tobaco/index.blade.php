...
@section('title', 'Emerging Tobacco Products')
@section('content')
    <section class="page-bg">
        <div class="container">
            <div class="" data-aos="fade-up" data-aos-delay="200">
                <h1 class="page-title">Emerging Tobacco Products</h1>
                ...
                <button class="page-btn"> <a href="{{ route('home') }}">Home</a> <i class="fas fa-arrow-right"></i>Our Expertise <i class="fas fa-arrow-right"></i>
                    Emerging Tobacco Products</button>
            </div>
        </div>
    </section>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 mb-5" v-for="(rows,index) in items.data" :key="index">
                ...
                <div class="card-body">
                    ...
                    <div class="info">
                        ...
                        <a :href="`/our_expertise/emerging_tobacco/${rows.id}`" style="margin-top: 20px" class="btn_read"
        ...
        $(document).ready(function() {
            var vue = new Vue({
                ...
                methods: {
                    ...
                    fetchData(page = 1) {
                        axios.get(`${this.config.base_path}/news-activities/Emerging-Tobacco?page=${page}`).then((
                            response) => {
