...
<section class="page-bg">
  <div class="container">
    <div class="" data-aos="fade-up" data-aos-delay="200">
      <h1 class="page-title">Mayor Alliance for Healthy Cities</h1>
      ...
      <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
          <div class="card-body">
              ...
              <div class="info">
                  ...
                  <a href="{{route('mayor_alliance_details',['id'=>1])}}" class="btn_read" target="_blank">Read More</a>
              </div>
          </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
