...
<section class="page-bg">
  <div class="container">
    <div class="" data-aos="fade-up" data-aos-delay="200">
      <h1 class="page-title">Seminar on "Importance of Standard Packaging Model to Protect Tobacco Tax Evasion in Bangladesh"</h1>
      <p class="page-desc">Date: October 5 2023.</p>
    </div>
  </div>
</section>
...
<section id="project" data-aos="fade-up" data-aos-delay="200">
  <div class="container">
    <div class="d-flex justify-content-center mb-3">
      <img src="assets/img/migration1.png" alt="" style="width: 40%">
    </div>
    <div class="item">
      <p>
      ...
      <div class="d-flex justify-content-center mb-3">
        <img src="assets/img/migration1.1.png" alt="" style="width: 40%">
      </div>
      <p>
      ...
      <a class="btn btn-warning" href="pdf/capacity_building1.pdf" download="downloaded_file.pdf">Download</a>
    </div>
  </div>
