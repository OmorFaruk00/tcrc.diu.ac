...
<section class="page-bg">
  <div class="container">
    <div class="" data-aos="fade-up" data-aos-delay="200">
      <h2 class="page-title">COP 27-Climate Change Debriefing Program at Parliament Members Club</h2>
      <p class="page-desc">Date: Feb 08, 2023.</p>
...
<section id="project" data-aos="fade-up" data-aos-delay="200">
  <div class="container">
    <div class="d-flex justify-content-center mb-3">
      <img src="assets/img/climate1.png" alt="" style="width: 40%">
    </div>
    <div class="item">
        <p>
        ...
        <a class="btn btn-warning" href="pdf/public_awareness1.pdf" download="downloaded_file.pdf">Download</a>
