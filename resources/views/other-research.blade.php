...
<section class="page-bg">
    <div class="container">
          <div class="" data-aos="fade-up" data-aos-delay="200">
            <h1 class="page-title">Other Research</h1>
            <p class="page-desc">Welcome to Bangladesh Center for Governance and Development, DIU.</p>
            <button class="page-btn"> <a href="{{route('home')}}">Home</a>  <i class="fas fa-arrow-right"></i> Other Research</button>         
          </div>        
      </div>
</section>
...
<section>
  <div class="container" data-aos="fade-up">
    <div class="row ">  
      ...
      <div class="col-lg-7  px-5" data-aos="fade-up" data-aos-delay="100">
          <h3 class="title-section">Centre for Excellence and Career Development (CECD) </h3>
           <p>
      ...
      <div class="col-lg-5" data-aos="fade-right" data-aos-delay="100">
        <img src="assets/img/cecd.png" class="page_img" alt="" style="height: 350px">
      </div>  
...
<section>
  <div class="container" data-aos="fade-up">
    <div class="row ">  
      <div class="col-lg-5 px-5" data-aos="fade-right" data-aos-delay="100">
        <img src="assets/img/sbac.png" class="page_img" alt="" style="height: 350px">
      </div>     
      <div class="col-lg-7 " data-aos="fade-up" data-aos-delay="100">
          <h3 class="title-section">Social Buusiness Academic 
            Cell (SBAC)  </h3>
           <p>
            Nobel Peace Prize Winner Prof. Muhammad Yunus wants to remove poverty from the world. For this reason, he launches a new business for helping for helping the poor which is known as social business is a cause driven business. In a social business, the investors or owners can gradually recoup the money invested, but cannot take any dividend beyond that point. The purpose of the investment is purely to achieve one or more social objectives though the operation of the company; no personal gain is desired by the investors. The company must cover all cost, make a profit, and at the same time achieve a social objective, such as, healthcare for the poor, housing for the poor, financial services for the poor, nutrition for malnourished children, providing safe drinking water, introducing renewable energy, etc. The impact of the business on people or the environment, rather then amount of profit made in a given period measures the success of a social business. sustainability of the company indicates that it is running as a business. 
           </p>
