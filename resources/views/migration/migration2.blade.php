...
<section class="page-bg">
  <div class="container">
    <div class="" data-aos="fade-up" data-aos-delay="200">
      <h1 class="page-title">Textiles and Jute Minister's support for strengthening and amendment Tobacco Control Act- TCRC team met with the Minister</h1>
...
<section id="project" data-aos="fade-up" data-aos-delay="200">
  <div class="container">
    <div class="d-flex justify-content-center mb-3">
      <img src="assets/img/migration2.png" alt="" style="width: 40%">
    </div>
    <div class="item">
      <p>
      ...
      <p>
        The honorable minister said that the process of amending the law to strengthen the law on the need for tobacco control is ongoing and I and my ministry have full support in this regard. Hon'ble Prime
      </p>
      <p>
