...
@section('title', 'International Partners')
...
<section class="page-bg">
    <div class="container">
      <div class="" data-aos="fade-up" data-aos-delay="200">
        <h1 class="page-title">Our International Partners</h1>
        ...
        <button class="page-btn"> <a href="{{ route('home') }}">Home</a> <i class="fas fa-arrow-right"></i>Networks<i class="fas fa-arrow-right"></i>
            International Partners</button>
      </div>
    </div>
  </section>

<section id="International" class="publication">
...
<script>
  $(document).ready(function () {
      var app = new Vue({
          ...
          methods: {
              getData() {
                  axios.get(`${this.config.base_path}/partner/International`)
                      .then((response) => {
