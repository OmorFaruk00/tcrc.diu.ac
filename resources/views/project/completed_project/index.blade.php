    ...
    <section class="page-bg">
        <div class="container">
            <div class="" data-aos="fade-up" data-aos-delay="200">
                <h1 class="page-title">Our Ongoing Projects
                </h1>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 mb-5" v-for="(rows,index) in items.data" :key="index">
                ...
                <div class="card-body">
                    ...
                    <div class="info">
                        ...
                        <a :href="`/project/completed_project/${rows.id}`" style="margin-top: 20px" class="btn_read"
        ...
        $(document).ready(function() {
            var vue = new Vue({
                ...
                methods: {
                    ...
                    fetchData(page = 1) {
                        axios.get(`${this.config.base_path}/news-activities/Completed-Project?page=${page}`).then((
                            response) => {
