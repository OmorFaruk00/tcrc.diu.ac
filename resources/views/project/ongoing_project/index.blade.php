            ...
            <div class="col-lg-3 col-md-6 col-sm-12 mb-5" v-for="(rows,index) in items.data" :key="index">
                ...
                <div class="card-body">
                    ...
                    <div class="info">
                        ...
                        <a :href="`/project/ongoing_project/${rows.id}`" style="margin-top: 20px" class="btn_read"
        ...
        $(document).ready(function() {
            var vue = new Vue({
                ...
                methods: {
                    ...
                    fetchData(page = 1) {
                        axios.get(`${this.config.base_path}/news-activities/Ongoing-Project?page=${page}`).then((
                            response) => {
