...
@section('title', 'Newspaper Article')
@section('content')
<style>
.publication-desc {
    display: -webkit-box;
...
<section class="page-bg">
  <div class="container">
        <div class="" data-aos="fade-up" data-aos-delay="200">
          <h1 class="page-title"> Newspaper Article
          </h1>
          <p class="page-desc">Welcome to Tobacco Control and Research Cell (TCRC), DIU.</p>
          <button class="page-btn"> <a  href="{{route('home')}}">Home</a>  <i class="fas fa-arrow-right"></i>Library <i class="fas fa-arrow-right"></i>Article <i class="fas fa-arrow-right"></i> Newspaper Article
          </button>         
        </div>        
    </div>
</section>
          ...
          <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12">
             <div class="publication">
              <a  :href="`/library/article/newspaper_article/${rows.id}`" target="_blank">
                <div class="publication-info">
                  <h4 v-text="rows.title">
                  </h4>              
                  <div class="publication-desc" v-html="rows.description"> </div>                 
        ...
        $(document).ready(function() {
            var vue = new Vue({
                ...
                methods: {
                    ...
                    fetchData(page = 1) {
                        axios.get(`${this.config.base_path}/research-publication/newspaper_articles?page=${page}`).then((
                            response) => {
