...
<section class="page-bg">
  <div class="container">
        <div class="" data-aos="fade-up" data-aos-delay="200">
          <h1 class="page-title"> Factsheet</h1>
          <p class="page-desc">Welcome to Tobacco Control and Research Cell (TCRC), DIU.</p>
          <button class="page-btn"> <a  href="{{route('home')}}">Home</a>  <i class="fas fa-arrow-right"></i> Factsheet</button>         
        </div>        
    </div>
</section>
          ...
          <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12">
             <div class="publication">
              <a href="{{ route('factsheet_details',['id'=>1]) }}" target="_blank">
