...
<section class="page-bg">
  <div class="container">
        <div class="" data-aos="fade-up" data-aos-delay="200">
          ...
          <button class="page-btn"> <a  href="{{route('home')}}">Home</a>  <i class="fas fa-arrow-right"></i>Library <i class="fas fa-arrow-right"></i> Publications
          </button>         
        </div>        
    </div>
</section>
          ...
          <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12">
             <div class="publication">
              <a  :href="`/library/publication/${rows.id}`" target="_blank">
        ...
        $(document).ready(function() {
            var vue = new Vue({
                ...
                methods: {
                    ...
                    fetchData(page = 1) {
                        axios.get(`${this.config.base_path}/research-publication/Publication?page=${page}`).then((
                            response) => {
